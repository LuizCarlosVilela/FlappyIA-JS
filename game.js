...
function startGame() {
    ...
    myscore = new Component({x: 2, y: 16, type: "text", fill: "#000000"});
...
function updateGameArea() {
    ...
    if (myGameArea.pause == false) {
        ...
        myscore.value = "Geracao: " + geracao + " (" + controle + "/" + numero_genomas + ")\n" +
            "|      Maior Record: " + record_fitness + " " +
            "|      Pontos Atuais: " + myscore.score;
